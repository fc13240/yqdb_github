...
<html>
	<head>
		<script type="text/javascript" src="/p2pstock/static/js/user/login/phonevalite.js"></script>
		<meta charset="utf-8">
								...
								<table width="100%">
									<tr>
										...
										<td width="40%" >
											...
											<s:form  action="/usercenter/updatePhoneNum_userCenterAction.action"
												method="post" theme="simple" id="phonevaliteform">
												...
												<fieldset style="border: 0px">
													...
													<div class="input-group margin-bottom-sm">
														<input type="button" id="phonevalite_CptBtn" value="免费获取验证码"></input>
													</div>
													<div class="input-group margin-bottom-sm">
														<input type="button" id="phonevalite_Btn" value='确定'></input>
													</div>
												</fieldset>
											</s:form>
										</td>

...
<div class="grid_10">
	<div class="p20bs color-white-bg fn-clear" id="maindiv" style="width:900px">
		...
		<div class="fn-clear head">
	     	<div class="title fn-left"><legend class="fieldset-lgend">用户基本信息</legend></div>
	     	<div class="fn-right">
	     		<a id="cancleInfoBtn" class="ui-button ui-button-mid ui-button-green" onclick="cancleinfo()">返回</a>
	     	</div>
	  	</div>

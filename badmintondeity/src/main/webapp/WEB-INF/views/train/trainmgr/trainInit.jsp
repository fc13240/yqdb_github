...
<script type="text/javascript">
		...
		<style type="text/css">
			...
			#bottomImg{
				width: 615px;
				height: 615px;
				background: url(images/ty-1@3x.png) no-repeat 0 0;
				margin: 0 auto;
				color: white;
				font-size: 56px;
				line-height: 615px;
	...
	<body>
		<div id="header">
			<div id="leftImg">
				<img src="/p2pstock/static/images/left.png"/>
			</div>
			<div id="headerTitle">一起动</div>
			<div id="rightImg"><img src="/p2pstock/static/images/option.png"/></div>
		</div>
		<div id="blank"></div>
		<div id="currentMode">
		...
		<div id="bottom">
			<div id="bottomImg"><span>开始</span>
				<a href="/p2pstock/activity/queryActivityInit_activityMgrAction.action?menucode=ACTIVITYPAGE">
            				...
            				<span id="activityDD" style="color:#999999">活动</span>
            	</a>
			</div>
		</div>
	</body>

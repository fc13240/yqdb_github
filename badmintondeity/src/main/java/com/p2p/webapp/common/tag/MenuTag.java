		...
		if("1".equals(menuorder)){
			...
			if(pubMenuList != null){
				...
				for(MenuInfo mi:pubMenuList){
					sb.append("<li id='li_" + mi.getMenu_code() +  "'>");
					sb.append("<a id='a_" + mi.getMenu_code()+ "' href='" + webroot + mi.getMenu_action()+ "?menucode="+ mi.getMenu_code() +"'>");
			...
			sb.append("<ul class='ui-side-list nav nav-list bs-docs-sidenav ' > ");

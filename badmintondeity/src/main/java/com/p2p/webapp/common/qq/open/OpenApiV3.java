package com.p2p.webapp.common.qq.open;
...
import com.p2p.webapp.common.qq.open.SnsNetwork;
import com.p2p.webapp.common.qq.open.SnsSigCheck;
import com.p2p.webapp.common.qq.open.SnsStat;
import com.p2p.webapp.common.qq.org.json.JSONException;
import com.p2p.webapp.common.qq.org.json.JSONObject;
...
public class OpenApiV3
{
    ...
    public String api(String scriptName, HashMap<String, String> params, String protocol) throws OpensnsException
    {
        ...
        params.put("userip", "10.0.0.1");
        params.put("format", "json");
        params.put("group_openid", "B2DA29192BA178B12DD94F9558840027");
        params.put("msg", "hello");
        params.put("union_id", "123456789");

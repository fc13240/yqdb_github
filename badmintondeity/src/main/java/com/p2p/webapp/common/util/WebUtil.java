 ...
 * Session最终是采用 Servlet容器来管理，或者采用 Spring Cache，由此控制。
 * 
 * @author <a href="mailto:eoems@sina.com">Lizhenzhong</a> at 2010-10-4 上午09:59:01
 * @version 1.0
 */
public class WebUtil {
	...
	public static String subUserIdPName = "SubUserId";//如：employee.id , member.id等
	 ...
	 * 如路径为http://localhost/appName/user/list.do, 得到的值为"user/list.do",其中appNames为应用的名字
	 * 
	 * @param request
	 * @return String
	 */
	...
	/**
	 * 获取不含端口号的域名。如：www.my.com,返回 .my.com:8080
	 * @param request
	 * @return
	 */
	...
	public static void addCookie(HttpServletResponse response, String name, String value, int maxAge) {
		...
		cookie.setPath(Constant.webContontRoot);
		if(maxAge>0)

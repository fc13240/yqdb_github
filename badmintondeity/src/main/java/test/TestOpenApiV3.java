...
import com.p2p.webapp.common.qq.open.ErrorCode;
import com.p2p.webapp.common.qq.open.OpenApiV3;
import com.p2p.webapp.common.qq.open.OpensnsException;
...
public class TestOpenApiV3
{
    ...
    {
        // 应用基本信息
        String appid = "1104898160";
        String appkey = "LbyoGFca2Pz43J16";

        // 用户的OpenID/OpenKey
        String openid = "168F50BB3DE20A9F0183F962586B762D";
        String openkey = "36A2F3CF380E95B7CF3AC59B843789C9";
    ...
    {
        // 指定OpenApi Cgi名字 
        String scriptName = "/v3/qqgroup/send_msg";
